...
| 290 | `290-spy-tv-result-cards-gradient.md` | Шпион TV: карточки результата раунда на градиент (как на телефоне) |
| 291 | `291-spy-draw-civilian-card-teal.md` | Шпион (мобильный): карточка слова в режиме «Нарисуй» — бирюзовая, как в «Угадай» |
...
| 337 | `337-spy-live-qa-fixes.md` | Шпион — 4 live-QA фикса (надпись хода, баг «Скрыть слово», отмена рисунка, скрыть голоса при голосовании) |
| 338 | `338-spy-discussion-phase.md` | Шпион — этап «Обсуждение» (2 минуты) между таймером раунда и голосованием |
| 339 | `339-spy-discussion-copy-tweak.md` | Шпион — правка текста на экране «Обсуждение» |
| 340 | `340-spy-question-target-chain.md` | Шпион (режим «Угадывай») — показывать КОМУ задан вопрос + передача хода по цепочке «спросили → теперь сам спрашивает» |
| 341 | `341-spy-question-cycle-no-repeat.md` | Шпион (режим «Угадывай») — не повторять адресата вопроса, пока не закончится полный круг |
| 342 | `342-whoami-judge-cards-stacked.md` | «Кто я?» — карточки «ответ/персонаж» на экране судьи друг под другом, а не рядом |

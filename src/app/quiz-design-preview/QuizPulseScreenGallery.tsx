    ...
    >
      {scores.map((entry, index) => (
        ...
        >
          ...
          <b className={`truncate leading-none ${compact ? density === 'large' ? 'text-[17px]' : density === 'medium' ? 'text-[14px]' : 'text-[12px]' : density === 'large' ? 'text-[clamp(16.25px,1.8125vw,26.25px)]' : density === 'medium' ? 'text-[clamp(13.75px,1.4375vw,21.25px)]' : 'text-[clamp(11.25px,1.25vw,17.5px)]'}`}>{entry.name}</b>
